...
import Foundation
struct QuizResultByQuizIDBase : Codable {
	let requestTime : String?
	let responseTime : String?
	let requestURL : String?
	let success : Bool?
	let message : String?
	let payload : QuizResultByQuizIDpayload?
	...
	init(from decoder: Decoder) throws {
		...
		payload = try values.decodeIfPresent(QuizResultByQuizIDpayload.self, forKey: .payload)
